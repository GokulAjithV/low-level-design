...
class StockSubject(ABC):
    ...
    def notify(self, symbol: str, price: float) -> None:
        # TODO: Notify all attached observers
        pass
...
class Stock(StockSubject):
    ...
    def set_price(self, new_price: float) -> None:
        # TODO: Set the new price, and trigger notifications
        pass
...
class PriceLogger(StockObserver):
    ...
    def update(self, symbol: str, price: float) -> None:
        # TODO: Log the change as a string "Symbol: Price" (e.g. "AAPL: 145.0") in self.log list.
        # Also print: f"PriceLogger: {symbol} is now ${price}"
        pass
...
class StockAlertSystem(StockObserver):
    ...
    def update(self, symbol: str, price: float) -> None:
        # TODO: If the price drops below the threshold, increment self.alerts_triggered.
        # Also print: f"ALERT: {symbol} has dropped below threshold! Current price: ${price}"
        pass
